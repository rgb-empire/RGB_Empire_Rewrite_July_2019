...
int Animation_Variables::random_palette()
{
	palette_current_ID = random8(0, gGradientPaletteCount);

	palette_current = gGradientPalettes[palette_current_ID];

	return palette_current_ID;
}

int Animation_Variables::random_palette_fade()
{
    palette_next_ID = random8(0, gGradientPaletteCount);

    palette_next = gGradientPalettes[palette_next_ID];

    return palette_next_ID;
}